...
int main()
{
	...
	//input text files
	cout << "Enter textfile for first village: ";
	cin >> filename1;
	cout << "Enter textfile for second village: ";
	cin >> filename2;

	
	//get count of families from each village
	java_families_count = utils.get_countof_families(filename1);
	py_families_count = utils.get_countof_families(filename2);
